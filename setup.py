...
setup(
  name = 'gruand-pdf-invoicing',         #* Your package will have this name
  packages = ['pdfinvoice'],   #* Name the package again
  ...
  author = 'gruand',                   # Your name
  author_email = 'gruand@gmail.com',  # Your email
  url = 'https://github.com/grudiy/pdf-invoice-generator',              # Homepage of your library (e.g. github or your website)
